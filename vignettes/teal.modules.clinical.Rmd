...
app <- teal::init(
  ...
  modules = list(tm_g_barchart_simple(label = "ADAE Analysis", x = teal.transform::data_extract_spec(
    dataname = "ADSL",
    select = teal.transform::select_spec(choices = teal.transform::variable_choices(ADSL), multiple = FALSE)
  )))
)

...
generate_adsl <- function(N = 200) { # nolint
  ...
  var_lbls_ind <- sapply(
    names(var_labels(tmc_ex_adsl)[is.na(var_labels(tmc_ex_adsl))]), function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_adsl[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]
...
generate_adaette <- function(adsl = tmc_ex_adsl) {
  ...
  var_lbls_ind <- sapply(
    ...
    function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_adaette[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]
...
generate_adeg <- function(adsl = tmc_ex_adsl,
  ...
  tmc_ex_adeg <- adeg %>%
    ...
    var_relabel(
      ...
      BASEC = "Baseline Character Value",
  ...
  var_lbls_ind <- sapply(
    names(var_labels(tmc_ex_adeg)[is.na(var_labels(tmc_ex_adeg))]), function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_adeg[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]
...
generate_adex <- function(adsl = tmc_ex_adsl,
  ...
  tmc_ex_adex <- adex %>%
    ...
    var_relabel(EXSEQ = "Analysis Sequence Number")

  var_lbls_ind <- sapply(
    names(var_labels(tmc_ex_adex)[is.na(var_labels(tmc_ex_adex))]), function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_adex[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]
...
generate_admh <- function(adsl = tmc_ex_adsl,
  ...
  var_lbls_ind <- sapply(
    names(var_labels(tmc_ex_admh)[is.na(var_labels(tmc_ex_admh))]), function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_admh[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]
...
generate_adqs <- function(adsl = tmc_ex_adsl,
  ...
  var_lbls_ind <- sapply(
    names(var_labels(tmc_ex_adqs)[is.na(var_labels(tmc_ex_adqs))]), function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_adqs[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]
...
generate_advs <- function(adsl = tmc_ex_adsl,
  ...
  var_lbls_ind <- sapply(
    names(var_labels(tmc_ex_advs)[is.na(var_labels(tmc_ex_advs))]), function(x) which(names(ex_var_labels) == x)
  )
  var_labels(tmc_ex_advs[names(var_lbls_ind)]) <- ex_var_labels[var_lbls_ind]

...
dynamically against the data. Some arguments still use
`teal.transform::choices_selected()` where noted in each module’s documentation.
The `tm_t_summary()` module illustrates the `variables()` pattern:

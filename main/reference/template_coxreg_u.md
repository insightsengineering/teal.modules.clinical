...
Creates a valid expression to generate a univariable Cox regression
analysis.
...
[`template_coxreg_m()`](https://insightsengineering.github.io/teal.modules.clinical/reference/template_coxreg_m.md),

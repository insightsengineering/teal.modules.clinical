...
- arm_var_r:
  ...
  (`reactive`)\
  reactive expression that returns the selected Treatment variable.

## Value

A [`shiny::reactive`](https://rdrr.io/pkg/shiny/man/reactive.html) that
runs arm/bucket validation and returns `NULL`.

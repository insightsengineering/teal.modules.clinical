...
Creates a valid expression to generate a table of multiple events by
term.
...
- seq_var:
  ...
  (`character`)  
  name of analysis sequence number variable. Used for counting the
...
[`tm_t_mult_events()`](https://insightsengineering.github.io/teal.modules.clinical/reference/tm_t_mult_events.md)

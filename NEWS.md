# teal.modules.clinical 0.8.10.9050.4
...
* Added `default_responses` argument to `tm_t_binary_outcome`, `tm_g_forest_rsp` to allow the user to specify default selected responses and possible response levels.

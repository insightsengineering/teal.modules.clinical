...
* Changed the decorated objects in `tm_g_pp_adverse_events`, `tm_g_pp_therapy`, `tm_t_pp_basic_info`, `tm_t_pp_laboratory` and `tm_t_pp_prior_medication` to a `ElementaryTable` generated by `rtables::build_table` (#1404).

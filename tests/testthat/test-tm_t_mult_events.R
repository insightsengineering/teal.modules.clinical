    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by(
          ...
          split_fun = split_fun,
          label_pos = "topleft",
          split_label = formatable::var_labels(adcm["ATC1"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by("ATC2",
          ...
          split_fun = split_fun,
          label_pos = "topleft",
          split_label = formatable::var_labels(adcm["ATC2"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by(
          ...
          split_fun = split_fun,
          label_pos = "topleft",
          split_label = formatable::var_labels(adcm["ATC3"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by("ATC4",
          ...
          label_pos = "topleft",
          split_label = formatable::var_labels(adcm["ATC4"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",

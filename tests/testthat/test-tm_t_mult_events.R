    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by(
          ...
          split_fun = split_fun,
          label_pos = "topleft",
          split_label = teal::get_variable_labels(adcm["ATC1"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
...
testthat::test_that("template_mult_events generates correct expressions with 2 HLT
  parameters and drop_arm_levels = FALSE", {
  result <- template_mult_events(
    dataname = "adcm",
    parentname = "adsl",
    arm_var = "ARM",
    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by("ATC2",
          ...
          split_fun = split_fun,
          label_pos = "topleft",
          split_label = teal::get_variable_labels(adcm["ATC2"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by(
          ...
          split_fun = split_fun,
          label_pos = "topleft",
          split_label = teal::get_variable_labels(adcm["ATC3"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
    ...
    layout = quote(
      lyt <- rtables::basic_table() %>%
        ...
        rtables::split_rows_by("ATC4",
          ...
          label_pos = "topleft",
          split_label = teal::get_variable_labels(adcm["ATC4"])
        ) %>%
        summarize_num_patients(
          var = "USUBJID",
          count_by = "ASEQ",
...
testthat::test_that("template_mult_events generates correct expressions with 1 HLT
  parameter and without 'All Patients' column", {
  result <- template_mult_events(
    dataname = "adcm",
    parentname = "adsl",
    arm_var = "ARM",

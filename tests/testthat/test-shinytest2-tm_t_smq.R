  ...
  init_teal_app_driver(
    teal::init(
      ...
      modules = tm_t_smq(
        ...
        dataname = "ADAE",
        parentname = "ADSL",
        arm_var = teal.picks::variables(choices = c("ARM", "SEX"), selected = "ARM"),
        ...
        baskets = teal.picks::variables(choices = starts_with("SMQ") | starts_with("CQ")),
        scopes = teal.picks::variables(choices = ends_with("SC")),
        llt = teal.picks::variables(choices = c("AEDECOD", "SEX"), selected = "AEDECOD"),
        pre_output = NULL,
        post_output = NULL,

# template_abnormality_by_worst_grade generates correct expressions with default arguments
    ...
    Output
      $data
      {
          anl_labels <- teal.widgets::formatters_var_labels(adlb, fill = FALSE)
          ...
          teal.widgets::formatters_var_labels(anl) <- c(anl_labels, GRADE_DIR = "   Direction of Abnormality", 
...
# template_abnormality_by_worst_grade generates correct expressions with custom arguments
    ...
    Output
      $data
      {
          anl_labels <- teal.widgets::formatters_var_labels(myadlb, fill = FALSE)

...
| [test-module](test-module/SKILL.md) | Compare **`X`** on **`main`** vs **`279`**: wait for output, screenshot module / Show R Code modal / Report→Show Report, write **`.test-module-reports/*.md`** with summary + both **`@examples`** code blocks. |

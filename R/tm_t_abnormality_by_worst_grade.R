...
tm_t_abnormality_by_worst_grade <- function(label, # nolint: object_length.
  ...
  paramcd <- .create_picks(teal.picks::datasets(dataname, dataname), paramcd)
  id_var <- .create_picks(teal.picks::datasets(dataname, dataname), id_var)
  atoxgr_var <- .create_picks(teal.picks::datasets(dataname, dataname), atoxgr_var)
  worst_high_flag_var <- .create_picks(teal.picks::datasets(dataname, dataname), worst_high_flag_var)
  worst_low_flag_var <- .create_picks(teal.picks::datasets(dataname, dataname), worst_low_flag_var)

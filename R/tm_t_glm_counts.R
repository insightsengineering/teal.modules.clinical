...
tm_t_glm_counts <- function(label = "Counts Module",
  ...
  offset_var <- create_picks_helper(teal.picks::datasets(dataname, dataname), offset_var)
  strata_var <- create_picks_helper(teal.picks::datasets(dataname, dataname), strata_var)

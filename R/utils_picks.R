...
#'
#' @param anl_selectors (`named list`) reactives from [`teal.picks::picks_srv()`].
#' @param merged_vars (`named list`) character vectors (ANL columns per slot) from `merge_srv()$variables()`.
#'
#' @keywords internal
#' @noRd
barchart_columns_source_for_relabel <- function(anl_selectors, merged_vars) {

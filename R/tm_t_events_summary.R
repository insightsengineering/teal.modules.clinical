...
tm_t_events_summary <- function(label,
  ...
  dthfl_var <- create_picks_helper(teal.picks::datasets(parentname, parentname), dthfl_var)
  dcsreas_var <- create_picks_helper(teal.picks::datasets(parentname, parentname), dcsreas_var)
  llt <- create_picks_helper(teal.picks::datasets(dataname, dataname), llt)
  aeseq_var <- create_picks_helper(teal.picks::datasets(dataname, dataname), aeseq_var)
  ...
  if (!is.null(flag_var_aesi)) {
    flag_var_aesi <- create_picks_helper(teal.picks::datasets(dataname, dataname), flag_var_aesi)
  }

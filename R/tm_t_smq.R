...
tm_t_smq <- function(label,
  ...
  baskets <- migrate_choices_selected_to_variables(baskets)
  scopes <- migrate_choices_selected_to_variables(scopes)
  ...
  teal.widgets::standard_layout(
    ...
    encoding = tags$div(
      ...
      tags$div(
        ...
        teal.picks::picks_ui(ns("baskets"), baskets)
      ),
      ...
      bslib::accordion(
        ...
        bslib::accordion_panel(
          ...
          tags$div(
            ...
            teal.picks::picks_ui(ns("scopes"), scopes)
          ),
          selectInput(

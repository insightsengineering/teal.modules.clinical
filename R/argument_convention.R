...
#' @param plot_height (`numeric`) optional,\cr a vector of length three with `c(value, min, max)`. Specifies the
#'   height of the main plot and renders a slider on the plot to interactively adjust the plot height.
#' @param plot_width (`numeric`) optional,\cr a vector of length three with `c(value, min, max)`. Specifies the width

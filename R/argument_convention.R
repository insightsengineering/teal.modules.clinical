...
#'   summarized.
#' @param subgroup_var (`choices_selected` or `data_extract_spec`)\cr object with all available choices and
...
#'
#' @return `module` object generated by the [teal::module()] functionhfdhhdt.
#'
